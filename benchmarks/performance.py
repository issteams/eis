"""Reproducible local EIS performance benchmark suite.
...
async def _timed(name: str, operation: Callable[[], Awaitable[Any]]) -> Measurement:
...
def benchmark_database() -> Measurement:
    ...
    with sqlite3.connect(":memory:") as db:
        ...
        db.executemany(
            "INSERT INTO evidence(content) VALUES (?)",
...
async def main() -> None:
    ...
    output = Path("benchmark-results/performance.json")
